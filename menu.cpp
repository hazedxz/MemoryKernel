...
void MenuRage2()
{
	...
	ImGui::Text("Pitch");
	const char* listbox_pitch[] = { "None", "Fakedown", "Down", "Up", "Jitter", "Random" };
	ComboBox("Pitch##1", &cvar.aa_pitch, listbox_pitch, IM_ARRAYSIZE(listbox_pitch), 6);

	if (cvar.aa_yaw == 7 || cvar.aa_yaw_while_running == 7)
	{
	...
	if (cvar.aa_roll == 7 || cvar.aa_roll_while_running == 7)
	{
		ImGui::Text("Static Roll");
		SliderFloat("Static Roll##1", &cvar.aa_roll_static, -180.f, 180.f, "Static Roll: %.0f");
	}
	ImGui::Text("Roll");
	const char* listbox_roll[] = { "None", "180", "180 Jitter", "Spin", "Jitter", "Sideways", "Random", "Static" };
	ComboBox("Roll##1", &cvar.aa_roll, listbox_roll, IM_ARRAYSIZE(listbox_roll), 8);
	ImGui::Text("Roll While Running");
	const char* listbox_rollrun[] = { "None", "180", "180 Jitter", "Spin", "Jitter", "Sideways", "Random", "Static" };
	ComboBox("Roll While Running##1", &cvar.aa_roll_while_running, listbox_rollrun, IM_ARRAYSIZE(listbox_rollrun), 8);
...
void MenuVisual3Window1()
{
	...
	if (viewmodelactive)
	{
		...
		deque<viewmodelchanger_t> ViewModels;
